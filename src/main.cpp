      ...
      if (s != "")
      {
        ...
        if (event == "telemetry")
        {
          ...
          */
          ...
          bool car_exist_left = false;
          bool car_exist_right = false;

          //find ref_v to use
          for (int i = 0; i < sensor_fusion.size(); i++)
          {
            // Identify the d position in Frenet
          ...
          */
          ...
          // if prev_size is small, generate previous positions from vechicle yaw and position.
          if (prev_size < 2)
          {
